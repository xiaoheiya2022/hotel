...
import com.qingge.springboot.utils.MD5Utils;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements IUserService {
    ...
    public void updatePassword(UserPasswordDTO userPasswordDTO) {
        userPasswordDTO.setPassword(MD5Utils.code(userPasswordDTO.getPassword()));
        userPasswordDTO.setNewPassword(MD5Utils.code(userPasswordDTO.getNewPassword()));
    ...
    @Override
    public Page<User> findEmployee(Page<User> page, String username, String email, String phone) {
        return userMapper.findEmployee(page, username, email, phone);
    }

    @Override
    public void leaveDo(Integer id) {
        userMapper.leaveDo(id);
    }

    @Override
    public void cancelLeave(Integer id) {
        userMapper.cancelLeave(id);
    }

    @Override
    public void addLeave(Integer id) {
        userMapper.addLeave(id);
    }
